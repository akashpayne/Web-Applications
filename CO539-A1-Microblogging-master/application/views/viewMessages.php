<!-- Displays a list of messages, with details of poster, content,
and time of each message. Poster's name should be linked to the
user/view/[poster] for that user -->
